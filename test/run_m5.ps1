...
##     algorithm config) **
##
## ++ Instead, make a LOCAL copy of this script (e.g., my_run_m5.ps1; do not
...
$L0_orb_cfg_str1 = "PREFIRE-SAT1,2024-07-25T09:00:00Z"
$L0_orb_cfg_str2 = "PREFIRE-SAT2,2024-10-04T00:00:00Z"
...
$env:OUTPUT_DIR = "$base_dir\outputs\m5"
...
$items = @($L0ocs1, $L0ocs2, $L0ocs3, $L0ocs4, $L0ocs5, $L0ocs6, $L0ocs7, $L0ocs8, $L0ocs9, $L0ocs10, $L0ocs11, $L0ocs12, $L0ocs13, $L0ocs14, $L0ocs15, $L0ocs16, $L0ocs17, $L0ocs18, $L0ocs19, $L0ocs20, $L0ocs21, $L0ocs22, $L0ocs23, $L0ocs24, $L0ocs25, $L0ocs26, $L0ocs27, $L0ocs28, $L0ocs29, $L0ocs30, $L0ocs31, $L0ocs32, $L0ocs33, $L0ocs34, $L0ocs35, $L0ocs36, $L0ocs37, $L0ocs38, $L0ocs39)
foreach ($cfg_str in $items) {
  $split_strarr = $cfg_str -split ","

  $env:SAT_ID = $split_strarr[0]
  $env:START_UTC = $split_strarr[1]
